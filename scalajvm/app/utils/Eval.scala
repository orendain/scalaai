...
// TODO: i added this manually - for debugging
...
class Eval(target: Option[File]) {
  ...
  /*// TODO: removed libpath for debugging
  ...
  */
  ...
  private[utils] def uniqueId(code: String, idOpt: Option[Int] = Some(jvmId)): String = {
  ...
  private[utils] def fileToClassName(f: File): String = {
